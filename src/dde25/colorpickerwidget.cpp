...
void CColorPickerWidget::setColorHexLineEdit()
{
    ...
    QValidator *validator = new QRegularExpressionValidator(reg, m_colHexLineEdit);
    m_colHexLineEdit->setValidator(validator);
...
void CColorPickerWidget::initUI()
{
    ...
    DSeparatorVertical *line = new DSeparatorVertical(this);
