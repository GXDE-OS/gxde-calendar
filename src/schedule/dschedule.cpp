 ...
 * Verbatim apart from includes and the removed QtDBus dependency.
 * ----------------------------------------------------------------------------
 * 移植自 dde-calendar（src/calendar-common/src/dschedule.cpp）。
 */
#include "dschedule.h"
#include "commondef.h"
...
// 参考实现靠 <QtDBus/QtDBus> 间接带进来这些 JSON 头，这里没有 QtDBus 了，
// 按实际用到的显式引一遍。
#include <QJsonArray>
